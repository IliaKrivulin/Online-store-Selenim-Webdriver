...
//await driver.wait(until.elementLocated(homeClick), 5000) // Ожидание
await driver.findElement(homeClick).click(); // 3.Переход на главную
//await driver.wait(until.elementLocated(tabletsSectionClick), 5000) // Ожидание
...
//await driver.wait(until.elementLocated(camerasSectionClick), 5000) // Ожидание
